# DadaCommandWhitelist 1.0

> Nasconde e blocca i comandi non permessi ai player.
...
**DadaCommandWhitelist 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Nasconde e blocca i comandi non permessi ai player.

| Field | Value |
| --- | --- |
| Plugin | `DadaCommandWhitelist` |
| Version | `1.0` |
| Category | Security and Staff Tools |
| Main class | `it.dadasmp.commandwhitelist.DadaCommandWhitelist` |
...
| --- | --- | --- |
| `dadacommandwhitelist.admin` | `op` | Permission node. |
| `dadacommandwhitelist.bypass` | `op` | Permission node. |
...
`release/DadaCommandWhitelist-1.0.jar`
